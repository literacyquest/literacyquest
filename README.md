...
`index.html` 하나에 화면, 수업 48개 (K 16개 + 1–2학년 공통 16개 + 3학년 16개), 이미지, CSS, JavaScript가 모두 들어 있습니다.
...
- 선택한 안내는 학습자별로 같은 브라우저에 저장됩니다. 4·5학년은 목표 미리보기만 제공하며 준비 중입니다.
...
K–5 학습 목표 미리보기를 제공합니다. 실제 수업은 K–5 전체 과정이 아니라 K 16차시, 1–2학년 공통 16차시, 3학년 16차시, 총 48차시의 보충학습입니다. K는 어른의 지원을 전제로 합니다.
