...
`index.html` 하나에 화면, 수업 32개 (K 16개 + 1–2학년 공통 16개), 이미지, CSS, JavaScript가 모두 들어 있습니다.
...
- Kindergarten 4주·16차시를 추가했습니다. Change grade → Kindergarten → Use Kindergarten guide로 시작하세요.
- 소리·운율, M/S/T 글자, 짧은 단어, 3문장 이야기, 질문 듣기, 구술·종이 그림 활동을 제공합니다.
- K는 한 단어 또는 어른이 받아 쓴 아이디어를 저장합니다. 기존 1–2학년은 6단어 조건을 유지합니다.
- K와 1–2학년은 과정별로 진도를 표시하며, 학년을 바꿔도 기존 기록이 남습니다.
...
- 선택한 안내는 학습자별로 같은 브라우저에 저장됩니다. 3·4·5학년은 목표 미리보기만 제공하며 준비 중입니다.
...
K–5 학습 목표 미리보기를 제공합니다. 실제 수업은 K–5 전체 과정이 아니라 K 16차시와 1–2학년 공통 16차시, 총 32차시의 보충학습입니다. K는 어른의 지원을 전제로 합니다.
