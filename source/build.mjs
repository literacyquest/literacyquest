...
fs.writeFileSync(path.join(root,'../index.html'),`<!doctype html><html lang="en"><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1"><meta name="theme-color" content="#176349"><meta name="description" content="Literacy Quest: Explore K–5 literacy goals. Explore 16 Kindergarten lessons and 16 shared Grade 1–2 lessons with family profiles and backups."><title>Literacy Quest | Read, Discover, Create</title><link rel="icon" type="image/svg+xml" href="data:image/svg+xml,${icon}"><style>${css}</style></head><body><div id="root"></div><noscript>Turn on JavaScript to use the lessons.</noscript><script>${js}</script></body></html>`);
