...
export const gradeGuidance = {
 ...
 '1': {label:'Read with support',word:'Read the practice words with a grown-up. Use the model to explore their sounds, word parts, or meanings.',read:'Read one paragraph at a time. Pause to tell a grown-up one thing you learned.',meaning:'Say your answer aloud. Point to the part of the text that helped you.',write:'Say your idea first. Use the sentence starter and write one or two clear sentences. Add more if you want.'},
 '2': {label:'Explain & extend',word:'Read the practice words aloud. Use the model to explore their sounds, word parts, or meanings, then try another example.',read:'Try reading independently first. Reread a tricky part and tell how the ideas connect.',meaning:'After choosing, explain why the answer fits. Use a detail from the text.',write:'Develop your answer in two or three connected sentences. Add a useful detail and a closing thought.'}
};
